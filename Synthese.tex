...
\definecolor{titlepagecolor}{cmyk}{0.,0.92,0.78,0.25}
...
\pagestyle{fancy}
\lhead{Anthony Rouneau, Julien Delplanque, Nicolas Leemans}
...
\begin{document}
	...
	\begin{center}
		...
		\includegraphics[scale=0.23]{Images/FS_Logo}\\
			\vspace*{2.5cm}
		%
		\titlefont Résumé d'Aide Multi-Critères à la Décision \par
		%
	\end{center}
	\vspace*{3cm}
	\hfill
	...
	\begin{minipage}{0.8\linewidth}
		\begin{flushleft}
			\textsf{\textbf{Résumé realisé par:}} Anthony Rouneau, 
				Nicolas Leemans, Julien Delplanque\\
			\textsf{\textbf{Section:}} 2$^{\grave{e}me}$ Bloc Master en 
